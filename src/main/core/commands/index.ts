...
import * as desktopClose from './desktop-close';
import * as desktopCreate from './desktop-create';
...
const COMMANDS = {
  ...
  [desktopClose.TRIGGER]: desktopClose.Command,
  [desktopCreate.TRIGGER]: desktopCreate.Command,
