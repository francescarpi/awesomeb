...
**AwesomeB** introduce una nueva manera de gestionar las pestañas: antes de cerrarlas, pasa por el estado de **suspenderlas**. ¿Y por qué? Porque, al final, los escritorios son una forma de organizar las pestañas según te convenga, y la funcionalidad de suspender pestañas te permite seguir teniéndolas ahí y volver a acceder al sitio web en el futuro.

![Estado de las pestañas](../../../../assets/close-tab-1.png)

En la captura anterior podemos ver una pestaña suspendida (1) y dos activas (2 y 3).

Hay varias formas de cerrar o suspender una pestaña:

## Suspender

<FeatureAccess entity="suspender una pestaña" macOS="Cmd+Shift+s" command="Suspend Tab" menu={['Tabs', 'Suspend tab']} />
...
<FeatureAccess entity="cerrar una pestaña" macOS="Cmd+w" command="Close Tab" menu={['Tabs', 'Close tab']} />
