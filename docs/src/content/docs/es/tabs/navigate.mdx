...
En este apartado te explicaré las diferentes formas que tienes para navegar entre pestañas.

Antes de nada, pero, tengo que explicarte el concepto de **tab container**.

![Contenedor de pestañas](../../../../assets/nav-tab-1.png)

Un *tab container* es un contenedor que puede tener varias pestañas. ¿Y por qué? Pues porque si por ejemplo haces un *split* de dos sitios web (2), el *tab container* contiene dos sitios web (uno a la izquierda y el otro a la derecha).
...
**AwesomeB** también introduce un innovador sistema para marcar las pestañas más frecuentes y para acceder a ellas rápidamente.
