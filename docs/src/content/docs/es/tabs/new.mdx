...
<FeatureAccess entity="nueva pestaña" shortcut="newTab" command="newTab" />

También puedes hacer clic en el botón **+** del panel izquierdo.

<Image src={NewTab8} width="300" alt="Botón nueva pestaña" />
...
2. Indicador de páginas (esquina superior derecha):
    * Muestra la página actual y el total, por ejemplo `Página 1 de 3: Buscar`.
    * Tres puntos clicables que te permiten saltar directamente a cualquier página.
    * Pulsa **Tab** para ir a la siguiente página, **Shift+Tab** para volver a la anterior.
3. Listado con:
