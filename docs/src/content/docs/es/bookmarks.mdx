...
## Guardar las pestañas de un escritorio

Puedes guardar todas las pestañas de un escritorio en favoritos de una sola vez. Haz clic derecho en un escritorio de la barra lateral y elige la opción *Guardar pestañas del escritorio en marcadores*. La opción solo está disponible cuando el escritorio tiene pestañas, estén activas o suspendidas.

<FeatureAccess entity="guardar las pestañas de un escritorio" command="bookmarksAddDesktop" contextMenu="contextDesktop.addTabsToBookmarks" />

El modal muestra cada pestaña de ese escritorio para que elijas cuáles guardar, selecciones una carpeta y pongas un nombre si creas una nueva. Después de guardarlas, las pestañas se cierran.
