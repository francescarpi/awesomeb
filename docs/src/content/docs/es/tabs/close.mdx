...
<FeatureAccess entity="suspender una pestaña" shortcut="suspendTab" command="suspendTab" menu="tabs.suspend" />
...
<FeatureAccess entity="cerrar una pestaña" shortcut="closeTab" command="closeTab" menu="tabs.close" />
