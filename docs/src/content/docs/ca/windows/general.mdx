...
<FeatureAccess entity="col·lapsar el panell esquerre" macOS="Cmd+s" command="Toggle Sidebar"/>
...
<FeatureAccess entity="maximitzar un lloc web" macOS="Cmd+i" command="Toggle Maximize Area"/>
