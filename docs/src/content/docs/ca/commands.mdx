...
<FeatureAccess entity="comandes" menu="file.performCommand" shortcut="performCommand"/>
...
Quan utilitzis la comanda **Canviar perfil** en una pestanya, aquesta conservarà la seva posició al llistat de pestanyes. Si està seleccionada, continuarà seleccionada després de canviar de perfil.
